    ...
    <div className="bg-[#f7f8fc]" id="services">
      <div className="pt-28 px-4 container mx-auto">
        <div className="text-center space-y-5">
          <h1 className="text-4xl font-bold font-Secoundary text-heroBg">
            Our Services
          </h1>
          <p className="sm:w-full md:w-1/2 mx-auto">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Fugiat illum dicta animi! In,
            accusantium rerum ullam consequuntur labore animi? Fugiat!
          </p>
        </div>
      </div>
      ...
      <div className="py-12 mx-auto md:w-[1100px]">
        <Tabs>
          ...
          <TabPanel className="mt-7">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="md:w-1/2 bg-white rounded-lg p-12 font-Secoundary">
                <h3 className="text-3xl font-semibold text-heroBg mb-4">
                  E-Commerce & Online Shopping
                </h3>
                <p className="mb-8">
                  Online retail platform offering a wide range of consumer goods.
                </p>
                <h4>Benefits</h4>
          ...
          <TabPanel className="mt-7">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="md:w-1/2 bg-white rounded-lg p-12 font-Secoundary">
                ...
                <p className="mb-8">
                  Import and distribution of petroleum products across Pakistan.
                </p>
                <h4>Benefits</h4>
                <ul className="list-disc list-inside space-y-3">
          ...
          <TabPanel className="mt-7">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="md:w-1/2 bg-white rounded-lg p-12 font-Secoundary">
                ...
                <p className="mb-8">
                  Large-scale wholesale and retail operations.
                </p>
                <h4>Benefits</h4>
                <ul className="list-disc list-inside space-y-3">
          ...
          {/* ✅ Travel & Tourism Services (with GALLERY BUTTON) */}
          <TabPanel className="mt-7">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="md:w-1/2 bg-white rounded-lg p-12 font-Secoundary">
                <h3 className="text-3xl font-semibold text-heroBg mb-4">
                ...
                <p className="mb-8">
                  Customized travel packages, hotel bookings, ticketing services.
                </p>
                <h4>Benefits</h4>
                <ul className="list-disc list-inside space-y-3">
                ...
                <button
                  onClick={goToGallery}
                  className="bg-heroBg text-white px-4 py-2 rounded-lg hover:font-bold mt-6"
                >
                  View More
                </button>
              </div>
          ...
          <TabPanel className="mt-7">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="md:w-1/2 bg-white rounded-lg p-12 font-Secoundary">
                ...
                <p className="mb-8">
                  Wholesale and retail trading of garments and textiles.
                </p>
                <h4>Benefits</h4>
                <ul className="list-disc list-inside space-y-3">
          ...
          <TabPanel className="mt-7">
            <div className="flex flex-col md:flex-row gap-4">
              <div className="md:w-1/2 bg-white rounded-lg p-12 font-Secoundary">
                ...
                <p className="mb-8">
                  Legally compliant crypto trading and investment solutions.
                </p>
                <h4>Benefits</h4>
                <ul className="list-disc list-inside space-y-3">
